...
#Package to Extreme gradient boosting
try:
...
#similar to XGBoost but faster, memory efficient and optimized for large datasets
try:
...
#good for categorical variables, reduces overfitting, nice for small datasets.
try:
    import catboost
    CB_OK = True
except:
...
class manage_RM(object):
    ...
    def __init__(self,
        ...
        #self.RM_version = "pyneb_internal_ann"
        #if self.verbose:
...
#        self.max_discret=max_discret
        ...
        # else:
        #this block of code was part of the else I unidenteded
    ...
    #TO BE DELETED THIS IS FOR FOR SK_ANN_Dis (Bin classification)
    # def discretize(self):
    ...
    #TO BE DELETED THIS IS ONLY NECESARY FOR BINNED-OUTPUT/one-hot
...
#         return new_y
    ...
    #TO BE DELEDTED, PyNeb does not requiere scale-y
    ...
    def train_RM(self, p_backend='loky', scoring=True):
        ...
        if self._multi_predic:
            ...
            #TO BE DELETED THIS IS MAINLY FOR KERAS
...
#                         print('RM trained{} Score = {:.3f}'.format(iter_str, train_score))
    ...
    #TO BE DELETED, ONLY FOR DISCRETIZED MODEL SK_ANN_Dis
    # def _norm_pred(self):
    ...
    #TO BE DELEDTED, does not form part of the Te, Ne calculation procedure
